...
function handleErrorMessage(errors: Record<string, string>) {
  if (errors.confirmTwoFactorAuthentication) {
    // @ts-expect-error cannot type this error
    return errors.confirmTwoFactorAuthentication.code ?? '';
  }
          ...
          >
            ...
            <div ref="pinInputContainerRef" class="relative w-full space-y-3">
              ...
              >
                ...
                <InputError :message="handleErrorMessage(errors)" />
              </div>
